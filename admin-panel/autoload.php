...
<head>
    ...
    <?php if ($page == 'sold_videos_analytics') { ?>
    ...
    <nav class="navbar">
        <div class="container-fluid">
            <div class="navbar-header">
                ...
                <a class="navbar-brand logo-img" href="<?php echo PT_Link(''); ?>" itemprop="url">
                    <img itemprop="logo" src="<?=$pt->config->site_url?>/themes/default/img/logo-light.png" alt="GamerDeadZone" width="90">
                <a class="hide-in-mobile navbar-brand" style="margin-top: 6px;margin-left: -30px;" href="<?php echo PT_Link(''); ?>"><?php echo $pt->config->title ?></a>
                </a>
        ...
        <aside id="leftsidebar" class="sidebar">
            ...
            <div class="menu">
                <ul class="list">
                    ...
                    <li <?php echo ($page == 'manage-games' || $page == 'add-platforms' || $page == 'add-games' || 
                    $page == 'edit-game') ? 'class="active"' : ''; ?>>
                        <a href="javascript:void(0);" class="menu-toggle">
                            <i class="material-icons">games</i>
                            <span>Games</span>
                        </a>
                        <ul class="ml-menu">
                            <li <?php echo ($page == 'add-platforms') ? 'class="active"' : ''; ?>>
                                <a href="<?php echo PT_LoadAdminLinkSettings('add-platforms'); ?>">Add Platforms</a>
                            </li>
                            <li <?php echo ($page == 'add-games') ? 'class="active"' : ''; ?>>
                                <a href="<?php echo PT_LoadAdminLinkSettings('add-games'); ?>">Add Games</a>
                            </li>
                            <li <?php echo ($page == 'manage-games') ? 'class="active"' : ''; ?>>
                                <a href="<?php echo PT_LoadAdminLinkSettings('manage-games'); ?>">Manage Games</a>
                            </li>
                        </ul>
                    </li>
                    <li <?php echo ($page == 'manage-tournaments' || $page == 'add-tournament') ? 'class="active"' : ''; ?>>
                        <a href="javascript:void(0);" class="menu-toggle">
                            <i class="material-icons">score</i>
                            <span>Tournament</span>
                        </a>
                        <ul class="ml-menu">
                            <li <?php echo ($page == 'add-tournament') ? 'class="active"' : ''; ?>>
                                <a href="<?php echo PT_Link('create-tournament'); ?>">Add Tournament</a>
                            </li>
                            <li <?php echo ($page == 'manage-tournaments') ? 'class="active"' : ''; ?>>
                                <a href="<?php echo PT_LoadAdminLinkSettings('manage-tournaments'); ?>">Manage Tournaments</a>
                            </li>
                        </ul>
                    </li>
                    ...
                    <li <?php echo ($page == 'manage-videos' || $page == 'import-from-youtube' || $page == 'import-from-dailymotion' || $page == 'sold_videos_analytics') ? 'class="active"' : ''; ?>>
                        <a href="javascript:void(0);" class="menu-toggle">
                    ...
                    <li <?php echo ($page == 'manage-articles' || $page == 'create-article' || $page == 'edit-article') ? 'class="active"' : ''; ?>>
                        ...
                        <ul class="ml-menu">
                            <li <?php echo ($page == 'create-article') ? 'class="active"' : ''; ?>>
                                <a href="<?php echo PT_LoadAdminLinkSettings('create-article'); ?>">Add New News</a>
                            </li>
                            <li <?php echo ($page == 'manage-articles') ? 'class="active"' : ''; ?>>
                                <a href="<?php echo PT_LoadAdminLinkSettings('manage-articles'); ?>">Manage News</a>
                            </li>
                        </ul>
                    </li>
