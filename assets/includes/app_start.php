...
require 'assets/import/challongeapi.php';
...
$pt->videos_array = PT_getDemo_video();
$pt->slider_array = PT_getSlider_image();
$pt->games_array = PT_getGames();
$pt->platforms_array = PT_getPlatforms();
$pt->challonge = new ChallongeAPI($pt->config->cha_api);
...
$rtl_langs           = array(
    'arabic', 'kurdish','kurdish_badini','Persian'
);
...
$pt->platforms = $db->get(T_PLATFORMS);
...
require 'assets/import/Paytm/config_paytm.php';         //PAYTM LIVRARY
require 'assets/import/Paytm/encdec_paytm.php';         //PAYTM LIVRARY
