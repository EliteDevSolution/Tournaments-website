...
define('T_TEAMS', 'team');
define('T_TEAMINVITE', 'team_invite');
define('T_TOURNAMENTS','tournaments');
define('T_PARTICIPANTS', 'participant');
define('T_PHONEVERI_REQUESTS', 'phone_verification_requests');
?>
